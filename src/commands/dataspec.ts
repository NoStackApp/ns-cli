...
export default class Dataspec extends Command {
  ...
  static flags = {
    ...
    resetLevel: flags.string({char: 'r', description: 'resetLevel for the stack being used.  Can currently be: "SAVE_EVERYTHING" or "ALL_BUT_MODERATOR".  By default, SAVE_EVERYTHING.'}),
  ...
  async run() {
    ...
    const json = await modifyStackFromSpec(flowSpec, userInfo, email, addedSuffix, resetLevel)
