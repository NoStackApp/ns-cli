...
async function createUserClass(options: CreateOptions) {
  console.log(`options=${JSON.stringify(options)}`)
  return true
}

async function createUser(options: CreateOptions) {
  console.log(`options=${JSON.stringify(options)}`)
  return true
}

async function createCollection(options: CreateOptions) {
  console.log(`options=${JSON.stringify(options)}`)
  return true
}

async function createSource(options: CreateOptions) {
  const collectionId = options.parent || isRequired('parent')
  const sourceName = options.value || isRequired('value')
...
async function createType(options: CreateOptions) {
  console.log(`options=${JSON.stringify(options)}`)
  return true
}

async function createConstraint(options: CreateOptions) {
  console.log(`options=${JSON.stringify(options)}`)
  return true
}

async function createSelection(options: CreateOptions) {
  console.log(`options=${JSON.stringify(options)}`)
  return true
}

async function createCreationAction(options: CreateOptions) {
  console.log(`options=${JSON.stringify(options)}`)
  return true
}

async function createUpdateAction(options: CreateOptions) {
  console.log(`options=${JSON.stringify(options)}`)
  return true
}

async function createInstance(options: CreateOptions) {
  console.log(`options=${JSON.stringify(options)}`)
  return true
}
...
export async function createQuery(options: CreateOptions) {
  // console.log(`options=${JSON.stringify(options)}`)
  const level = options.level || isRequired('level')
  // @ts-ignore
  const query = await queryForLevel[level](options)
  // console.log(`query=${query}`)

  await genericApiCall(query, options.userInfo)
}
