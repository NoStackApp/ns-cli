...
//
//           try {
//             await generateTypeFile(type, source, boilerPlateType, currentStack)
//
//           } catch (errWithCreate) {
//             throw new Error(`error with first generateTypeFile: ${errWithCreate}`)
//           }
//
//
//
...
//             await generateTypeFile(type, source, creationBoilerPlateType, currentStack)
//
//             const singularBoilerPlateType = formTypes.SINGLE_INSTANCE + dataType + nodeType
//             await generateTypeFile(type, source, singularBoilerPlateType, currentStack)
//           }
//         } catch (err) {
